...
private fun FirLightDiagnostic.toPsiDiagnostic(): FirPsiDiagnostic<*> {
    ...
    return when (this) {
        is FirLightSimpleDiagnostic -> FirPsiSimpleDiagnostic(
            psiSourceElement,
            severity,
            factory as FirDiagnosticFactory0<FirPsiSourceElement<PsiElement>, PsiElement>
        )
        ...
        is FirLightDiagnosticWithParameters1<*> -> FirPsiDiagnosticWithParameters1(
            ...
            a,
            severity,
            factory as FirDiagnosticFactory1<FirPsiSourceElement<PsiElement>, PsiElement, Any>
        )
        ...
        is FirLightDiagnosticWithParameters2<*, *> -> FirPsiDiagnosticWithParameters2(
            ...
            a, b,
            severity,
            factory as FirDiagnosticFactory2<FirPsiSourceElement<PsiElement>, PsiElement, Any, Any>
        )
        ...
        is FirLightDiagnosticWithParameters3<*, *, *> -> FirPsiDiagnosticWithParameters3(
            ...
            a, b, c,
            severity,
            factory as FirDiagnosticFactory3<FirPsiSourceElement<PsiElement>, PsiElement, Any, Any, Any>
        )
