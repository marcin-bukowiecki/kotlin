...
public class DiagnosisCompilerFirTestdataTestGenerated extends AbstractDiagnosisCompilerTestDataTest {
    ...
    public static class Resolve extends AbstractDiagnosisCompilerTestDataTest {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class Exhaustiveness extends AbstractDiagnosisCompilerTestDataTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doTest, this, testDataFilePath);
            }
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class Stdlib extends AbstractDiagnosisCompilerTestDataTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doTest, this, testDataFilePath);
            }
    ...
    public static class ResolveWithStdlib extends AbstractDiagnosisCompilerTestDataTest {
        ...
        public static class Contracts extends AbstractDiagnosisCompilerTestDataTest {
            ...
            @TestDataPath("$PROJECT_ROOT")
            @RunWith(JUnit3RunnerWithInners.class)
            public static class FromSource extends AbstractDiagnosisCompilerTestDataTest {
                private void runTest(String testDataFilePath) throws Exception {
                    KotlinTestUtils.runTest(this::doTest, this, testDataFilePath);
                }
                ...
                @TestDataPath("$PROJECT_ROOT")
                @RunWith(JUnit3RunnerWithInners.class)
                public static class Bad extends AbstractDiagnosisCompilerTestDataTest {
                    private void runTest(String testDataFilePath) throws Exception {
                        KotlinTestUtils.runTest(this::doTest, this, testDataFilePath);
                    }
                ...
                @TestDataPath("$PROJECT_ROOT")
                @RunWith(JUnit3RunnerWithInners.class)
                public static class Good extends AbstractDiagnosisCompilerTestDataTest {
                    private void runTest(String testDataFilePath) throws Exception {
                        KotlinTestUtils.runTest(this::doTest, this, testDataFilePath);
                    }
                    ...
                    @TestDataPath("$PROJECT_ROOT")
                    @RunWith(JUnit3RunnerWithInners.class)
                    public static class VariousContracts extends AbstractDiagnosisCompilerTestDataTest {
                        private void runTest(String testDataFilePath) throws Exception {
                            KotlinTestUtils.runTest(this::doTest, this, testDataFilePath);
                        }
